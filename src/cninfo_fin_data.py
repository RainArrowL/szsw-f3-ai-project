...
NOTES_FIELDS_CN = {
    ...
    "NETPROFITRPHBZC": "净利润环比",
    "NON_PERFORMING_LOAN": "不良贷款余额",
    "NONPERLOAN": "不良贷款率(%)",
    "LOAN_PROVISION_RATIO": "拨贷比(%)",
    "FIRST_ADEQUACY_RATIO": "资本充足率(%)",
    "NEWCAPITALADER": "一级资本充足率(%)",
    ...
    "TAXRATE": "实际税率(%)",
    "NCO_OP": "营业利润率(%)",
    "NCO_NETPROFIT": "销售净利润率(%)",
    "NCO_FIXED": "固定资产周转率(%)",
    "ZZCJLL": "总资产净利率(%)",
    "ZZCJLLTZ": "总资产净利率同比(%)",
    "JYXJLYYSR": "经营现金流/营业收入",
    "KCFJCXSYJLR": "经营现金流净额/净利润",
    "KCFJCXSYJLRTZ": "经营现金流净额/净利润同比(%)",
    "KFJLRGDHBZC": "净利润同比(%)",
    # 偿债指标
    "CURRENT_RATIO": "流动比率",
    "DEBT_ASSET_RATIO": "资产负债率",
    ...
    "MONETARYFUNDS_RATIO": "货币资金同比(%)",
    "ACCOUNTS_RECE_RATIO": "应收账款同比(%)",
    "OI_YOYRATIO_PK": "营业总收入同比(%)",
    "TA_YOYRATIO_PK": "资产总计同比(%)",
    "EQUITY_YOYRATIO_PK": "股东权益同比(%)",
    "YYZSRGDHBZC": "营业收入环比",
    "YSZKYYSR": "应收账款/营业收入",
    "YSZKZZL": "应收账款周转率",
    "YSZKZZTS": "应收账款周转天数",
    ...
    "INVENTORY_TR_YOY": "存货周转率同比",
    # 环比指标 (DJD = 单季度)
    "DJD_DEDUCTDPNP_QOQ": "扣非净利润环比(%)",
    "DJD_DEDUCTDPNP_YOY": "扣非净利润同比(%)",
    "DJD_DPNP_QOQ": "净利润环比(%)",
    "DJD_DPNP_YOY": "净利润同比(%)",
    "DJD_TOI_QOQ": "营业总收入环比(%)",
    "DJD_TOI_YOY": "营业总收入同比(%)",
    ...
    "LTDRR": "贷款拨备率(%)",
    "REVENUE_RATIO": "营收增长率(%)",
    "RCAPITAL_RATIO": "核心资本充足率(%)",
    "RCOST_RATIO": "成本收入比(%)",
    "NET_ASSETS_LIABILITIES": "净资产负债率",
    "NET_CAPITAL_LIABILITIES": "净资本负债率",
    "FC_LIABILITIES": "流动负债",
    ...
    "JJYWFXZB": "经营型风险指标",
    "RZRQYWFXZB": "融资型风险指标",
    "ZQCXYWFXZB": "证券承销型风险指标",
    "ZQZYYWFXZB": "证券自营型风险指标",
    "YYFXZB": "营业型风险指标",
    "JZB": "净资本",
    "JZBJZC": "净资本/净资产",
    "JZC": "净资产",
    ...
    "ZYGPGMJZC": "每股账面价值",
    # 其他
    "AVG_NET_PROFIT": "平均净利润",
    "AVG_TOI": "平均营业总收入",
    "FCFF_BACK": "后向自由现金流",
    "FCFF_FORWARD": "前向自由现金流",
    "NHJZ_CURRENT_AMT": "内含价值",
    "OVERDUE_LOANS": "逾期贷款",
    "PER_EBIT": "每股EBIT",
    "XSMLL_TB": "销售毛利率(摊薄)",
}
